...
#'
#' Returns the 30 most recent public events from Github (within the last 90 days), including all metadata, as a list of lists.
#'
#' @param path string
#'
#' @return list
...
#'
#' Returns a dataframe with selected information about the 30 most recent events from Github (within the last 90 days). Information includes event type, actor, repo and payload if the event was a push.
#'
#' @param path string
#'
